(function(GameState){
	...
	var Preloader = (function(){
		...
		Preloader.prototype.preload = function(){
			...
			this.load.atlasJSONArray('level_animation', 'assets/level_animations/level_animation.png', 'assets/level_animations/level_animation.json' );	
			//player
			...
			this.load.atlasJSONArray('jimmy_sheet', 'assets/EnemyJimmy/Jimmy_sprite.png', 'assets/EnemyJimmy/Jimmy_sprite.json');
